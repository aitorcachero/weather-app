  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-dark-primary via-dark-secondary to-dark-tertiary">
      ...
      <div className="lg:hidden w-full min-h-screen flex flex-col">
        ...
        <header className="sticky top-0 z-40 bg-gradient-to-br from-dark-primary to-dark-secondary backdrop-blur-xl border-b border-white/10 p-4">
          <form
        ...
        <div className="overflow-y-auto pb-20 pt-[540px]">
          {/* Información detallada */}
