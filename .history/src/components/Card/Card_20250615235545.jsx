            ...
            <section className="flex-1 p-8 min-h-[400px]">
              {weather && weather.cod === 200 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 h-full">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300  bg-black/50  shadow-lg shadow-black/30 border-blue-500/50">
