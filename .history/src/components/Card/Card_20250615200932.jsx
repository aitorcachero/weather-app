      ...
      >
        ...
        <main className="flex flex-col w-3/4 h-full bg-gradient-to-br from-accent-cyan/5 to-accent-purple/5 backdrop-blur-3xl relative">
          ...
          {weather && weather.cod === 200 && (
            <>
              {/* Header principal */}
              <header className="flex justify-between items-center p-12 bg-gradient-to-br from-black/40 to-black/20 backdrop-blur-3xl border-b border-white/10 relative">
              ...
              <section className="flex-1 p-8 overflow-y-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 h-full">
                  {/* Temperatura */}
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl transition-all duration-300 glass-hover hover:-translate-y-1 hover:shadow-xl hover:shadow-black/30 group relative overflow-hidden">
