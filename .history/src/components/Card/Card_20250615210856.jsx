...
export default function Card() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-dark-primary via-dark-secondary to-dark-tertiary">
      ...
      <div className="lg:hidden w-full min-h-screen flex flex-col bg-gradient-to-br from-dark-primary via-dark-secondary to-dark-tertiary">
        {loading && (
        ...
        {/* Header en mobile */}
        <header className="flex-shrink-0 bg-gradient-to-br from-black/80 to-black/60 backdrop-blur-xl border-b border-white/20 p-4 shadow-lg">
          <form
            className="flex gap-3 mb-4"
            onSubmit={(e) => handleSubmit(e, search)}
          >
            <input
              className="flex-1 h-12 rounded-xl border border-white/20 outline-none px-4 py-3 font-medium bg-white/10 text-white backdrop-blur-xl transition-all duration-300 placeholder:text-white/60 placeholder:font-normal focus:bg-white/20 focus:border-accent-cyan focus:shadow-lg focus:shadow-accent-cyan/20 text-sm"
              type="text"
              placeholder="🔍 Buscar ciudad..."
              value={search}
              onChange={(e) => setSearch(e.target.value)}
            />
            <button
              className="h-12 px-6 rounded-xl border-none outline-none font-bold cursor-pointer text-white bg-gradient-to-r from-accent-cyan to-accent-purple transition-all duration-300 uppercase tracking-wider relative overflow-hidden hover:brightness-110 text-sm"
              type="submit"
            >
              ⚡
            </button>
          ...
          {weather && weather.cod === 200 ? (
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  <span className="text-lg font-semibold text-white/90 capitalize block drop-shadow-md">
                    {weather.weather[0].description}
                  </span>
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold text-white/50 mb-2 drop-shadow-lg">
                Ciudad, País
              </h1>
              <div className="flex items-center justify-center gap-4">
                <span className="text-5xl font-mono font-black text-white/50 drop-shadow-lg">
                  --°
                </span>
                <div className="text-left">
                  <span className="text-lg font-semibold text-white/50 capitalize block drop-shadow-md">
                    Descripción del clima
                  </span>
