  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-dark-primary via-dark-secondary to-dark-tertiary">
      ...
      <div className="lg:hidden w-full min-h-screen">
        ...
        <header className="md:sticky relative top-0 z-40 bg-gradient-to-br from-dark-primary to-dark-secondary backdrop-blur-xl border-b border-white/10 p-4">
          <form
            className="flex gap-3 mb-4"
            onSubmit={(e) => handleSubmit(e, search)}
          >
            <input
              className="flex-1 h-12 rounded-xl border border-white/20 outline-none px-4 py-3 font-medium bg-glass-light text-white backdrop-blur-xl transition-all duration-300 placeholder:text-white/60 placeholder:font-normal focus:bg-glass-medium focus:border-accent-cyan focus:shadow-lg focus:shadow-accent-cyan/20 text-sm"
              type="text"
              placeholder="🔍 Buscar ciudad..."
              value={search}
              onChange={(e) => setSearch(e.target.value)}
            />
            <button
              className="h-12 px-6 rounded-xl border-none outline-none font-bold cursor-pointer text-white gradient-bg transition-all duration-300 uppercase tracking-wider relative overflow-hidden hover:brightness-110 shimmer-effect text-sm"
              type="submit"
            >
              ⚡
            </button>
          ...
          {weather && weather.cod === 200 ? (
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  <span className="text-lg font-semibold text-white/90 capitalize block">
                    {weather.weather[0].description}
                  </span>
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold text-white/30 mb-2">
                Ciudad, País
              </h1>
              <div className="flex items-center justify-center gap-4">
                <span className="text-5xl font-mono font-black text-white/30">
                  --°
                </span>
                <div className="text-left">
                  <span className="text-lg font-semibold text-white/30 capitalize block">
                    Descripción del clima
                  </span>
                  <span className="text-sm text-white/30">Sensación: --°</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="overflow-y-auto pb-20 pt-4">
          {/* Información detallada */}
