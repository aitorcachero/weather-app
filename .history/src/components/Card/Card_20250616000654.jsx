            ...
            <section className="flex-1 p-8 min-h-[400px]">
              {weather && weather.cod === 200 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 h-full">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300  bg-black/20  shadow-lg shadow-black/30 border-blue-500/50">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300 shadow-lg shadow-black/30 border-green-500/50 bg-black/20">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300 shadow-lg shadow-black/30 border-purple-500/50 bg-black/20">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300 shadow-lg shadow-black/30 border-yellow-500/50 bg-black/20">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300 shadow-lg shadow-black/30 border-orange-500/50 bg-black/20">
                  ...
                  <div className="flex items-center gap-6 p-8 glass-effect rounded-2xl min-h-[120px] transition-all duration-300 shadow-lg shadow-black/30 border-gray-500/50 bg-black/20">
                ...
                <>
                  <div className="flex items-center gap-6 p-6 glass-effect rounded-xl min-w-[200px] opacity-30">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-mono font-medium text-white/30">
                        --:--
                      </p>
                    </div>
                  </div>
              ...
              {lastSearchs && lastSearchs.length > 0 && (
                <>
                  <ul className="flex flex-col gap-4 list-none m-0 p-0">
                    {lastSearchs.slice(0, 8).map((search, index) => (
                      <li
                        key={index}
